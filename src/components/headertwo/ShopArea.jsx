        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <div className="section-title title-style-two text-center mb-70">
                <h2 className="title">Safe and seemless Transactions.</h2>
              </div>
            </div>
          </div>
          <div class="py-5">
          ...
          {/* <div className="row justify-content-center">
            <div className="col-xl-4 col-lg-5 col-md-6 col-sm-9">
              < className="shop-item mb-60">
                <div className="shop-thumb">
                  <img src="assets/img/shop/shop_wrap_img.png" alt="" className="shape" />
                  <a href="/shop-details"><img src="assets/img/masters/1.jpg" alt="" className="shop-img" /></a>
            ...
            <div className="col-xl-4 col-lg-5 col-md-6 col-sm-9">
              ...
              <a href="https://t.me/Punterexe" className="btn">Get ID Now...</a>
            </div>
        </div>
