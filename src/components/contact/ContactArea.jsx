      ...
      <div className="row justify-content-center">
        <div className="col-lg-7">
          <div className="contact-wrap">
            ...
            <form action="https://t.me/Punterexe" className="contact-form">
              ...
              <button type="submit" className="btn">Get ID</button>
            </form>
          </div>
        </div>
          ...
          <div className="contact-info-wrap">
            ...
            <div className="contact-social">
              <ul>
                ...
                <li><a href="https://t.me/Punterexe"><i className="fab fa-pinterest-p" /></a></li>
              </ul>
            </div>
          </div>
        </div>
