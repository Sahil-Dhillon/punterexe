      ...
      <div className="row">
        <div className="col-lg-4">
          <div className="tournament-content">
            <h6 className="sub-title">check out our latest</h6>
            <h4 className="title">CONTESTS & GAMES</h4>
            <p>Explore a wide range of thrilling betting options on our platform. Whether you're a fan of football, basketball, tennis, or eSports, we've got you covered with exciting matches and events.</p>
            <a href="/our-squad" className="btn">EXPLORE</a>
          </div>
        </div>
        <div className="col-lg-3">
          <div className="prize-pool">
            <h3 className="title">WIN BIG</h3>
            <h5 className="prize">₹10 CRORE</h5>
            ...
            <Slider className="winner-active" {...settings}>
              <div className="winner-item">
                ...
                <div className="winner-content">
                  <span className="place">Gaurav Kapoor</span>
                </div>
              </div>
              <div className="winner-item">
                <div className="winner-thumb">
                ...
                <div className="winner-content">
                  <span className="place">Abhishek Gandhi</span>
                </div>
              </div>
              <div className="winner-item">
                <div className="winner-thumb">
                ...
                <div className="winner-content">
                  <span className="place">Suresh Kumar</span>
                </div>
              </div>
              <div className="winner-item">
                <div className="winner-thumb">
                ...
                <div className="winner-content">
                  <span className="place">Sonupreet</span>
                </div>
              </div>
            </Slider>
          </div>
