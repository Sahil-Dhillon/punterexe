...
function Live() {
 ...
 useEffect(function(){
  ...
  return (
    ...
    <section className="live-stream-area live-stream-bg pb-120">
          ...
          <div className="col-xl-4">
            <div className="live-stream-content">
              ...
              <div className="section-title">
                <h4 className="sub-title">Enjoy</h4>
            ...
            <div className="live-videos-wrapper">
              ...
              > */}
                ...
                <div className="live-video-item">
                  <div className="video">
                    <video className="liveVideo" autoPlay muted loop >
                      <source src="assets/videos/casino1.mp4" type="video/mp4" />
                    </video>
                  </div>
                ...
                <div className="live-video-item">
                  <div className="video">
                    <video className="liveVideo" autoPlay muted loop >
                      <source src="assets/videos/casino3.mp4" type="video/mp4" />
                    </video>
                  </div>
                  <div className="coming-time" data-countdown="2022/5/29" />
                  <a href="#" target="blank" className="btn">watch live <i className="fas fa-play-circle"></i> </a>
